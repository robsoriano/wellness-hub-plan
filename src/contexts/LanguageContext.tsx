...
const translations = {
  en: {
    ...
    'patientDashboard.dailyMeals': 'Today\'s Meals',
    'patientDashboard.noActivePlan': 'No active meal plan',
    'patientDashboard.noMealsToday': 'No meals scheduled for today',
    'patientDashboard.waterIntake': 'Water Intake',
    'patientDashboard.dailyGoal': 'Daily goal',
    'patientDashboard.glasses': 'glasses',
    'patientDashboard.goalReached': 'Goal reached! Great job staying hydrated!',
  ...
  es: {
    ...
    'patientDashboard.dailyMeals': 'Comidas de Hoy',
    'patientDashboard.noActivePlan': 'Sin plan de comidas activo',
    'patientDashboard.noMealsToday': 'No hay comidas programadas para hoy',
    'patientDashboard.waterIntake': 'Consumo de Agua',
    'patientDashboard.dailyGoal': 'Meta diaria',
    'patientDashboard.glasses': 'vasos',
    'patientDashboard.goalReached': '¡Meta alcanzada! ¡Excelente hidratación!',
